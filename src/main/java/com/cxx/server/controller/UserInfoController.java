...
@Tag(name = "SourceController", description = "用户管理")
@RestController
...
public class UserInfoController {
    ...
    @ResponseBody
    public ResponseDTO<UserInfoVO> delete(@PathVariable("user_id") Long userId) {
        return null;
    }
    ...
    @ResponseBody
    public ResponseDTO<UserInfoVO> update(@PathVariable("user_id") Long userId) {
        return null;
    }
}
